...
start %SystemRoot%\Sysnative\cmd.exe  ""!_cmdf!" %* r1"
exit /b
)

if exist %SystemRoot%\SysArm32\cmd.exe if %PROCESSOR_ARCHITECTURE%==AMD64 if not defined r2 (
setlocal EnableDelayedExpansion
start %SystemRoot%\SysArm32\cmd.exe  ""!_cmdf!" %* r2"
exit /b
)
...
echo:        Data: %data%
echo: 
call :_color2 %_White% "        Computador:" %_Red% "%computername%"
call :dk_color %_Blue% "                                                Proxima pagina aperte [A]"
call :_color2 %_White% "        Usuario:" %_Red% "%username%"
echo:        
echo:       ______________________________________________________________
echo:
call :_color2 %_Green% "             Menu 1           " %Magenta% "OPCOES DO WINDOWS"
echo:
echo:             [1] IP DA MAQUINA
echo:
echo:             [2] PING
echo:
echo:             [3] INFORMACOES SISTEMA     
echo:                                                                     
echo:             [4] PAINEL DE CONTROLE
echo:
echo:             [5] DISPOSITIVOS E IMPRESSORAS 
echo:  
echo:             [6] OPCOES DE ENERGIA
echo:
echo:             [7] IPs EM REDE [cabeados]
echo:
echo:             [8] TROCAR NOME DA MAQUINA 
echo:
echo:             [9] COLOCAR APP EM INICIALIZAR DO WINDOWS                   
echo:       ______________________________________________________________
call :_color2 %_White% "                                 0. SAIR" %_Green% "         A-Proximo "
echo:
call :_color %_Yellow% "            Escolha uma opcao [1,2,3,4,5,6,7,8,9] :"

choice /C:1234567890A /N 
set _erl=%errorlevel%

echo ------------------------------
if %_erl%==1 goto opcao1 
if %_erl%==2 goto opcao2
if %_erl%==3 goto opcao3
if %_erl%==4 goto opcao4
if %_erl%==5 goto opcao5
if %_erl%==6 goto opcao6
if %_erl%==7 goto opcao7
if %_erl%==8 goto opcao8
if %_erl%==9 goto opcao9
if %_erl%==10 goto exit
if %_erl%==11 goto Menu2
...
echo:
call :_color2 %_White% "        Computador:" %_Red% "%computername%"
call :dk_color %_Blue% "                                               Pagina anterior aperte [A]"
call :_color2 %_White% "        Usuario:" %_Red% "%username%"
echo:
echo:       ______________________________________________________________
echo:
call :_color2 %_Green% "             Menu 2           " %Magenta% "OPCOES DO SISTEMA"
echo:
echo:             [1] LIMPA SPOOLER DE IMPRESSAO
echo:
echo:             [2] DELETA TXT TempSAT
echo:
echo:             [3] DELETA TXT Vicomerce\imp
echo:                                                                     
...
echo:             [7] 
echo:
echo:             [8] SETAR USUARIO ATUAL COMO ADM
echo:
echo:             [9] M.A.S Ativador do Windows                                 
echo:       ______________________________________________________________
call :_color2 %_Green% "              Anterior-A" %_White% "         0. SAIR"
echo:
call :_color %_Yellow% "            Escolha uma opcao [1,2,3,4,5,6,7,8,9] :"
...
::------------------------------------------------------------------------------
	...
	:opcao8
		...
		echo.
		echo.
		set /p novoN= Digite o novo nome de maquina:
		wmic computersystem where caption='%computername%' rename %novoN%
		echo.
		
		echo Maquina renomeada, deseja reiniciar o PC ?

		choice /C SN 

		if errorlevel 2 goto opcaoN
		if errorlevel 1 goto opcaoS
		
		:opcaoN
		echo  ====OK NAO Desligar====
		pause 
		goto MainMenu
...
::------------------------------------------------------------------------------
	...
	:op2
		cls
		echo.
		echo Deletar arquivos da pasta tempSAT/Imp
		echo.
		echo Aperte [0] para voltar ao Menu
		echo.
		choice /C:SN0
		set _erl=%errorlevel%
		if %_erl%== 1 goto deletar
		if %_erl%== 2 goto NAO
		...
		:NAO
		echo.
		echo OK arquivos NAO deletatos
		echo.
		pause
		goto Menu2
	...
	:op3
		cls
		echo.
		echo Deletar arquivos da pasta C:\Vicommerce\Imp
		echo.
		echo Aperte [0] para voltar ao Menu
		echo.
		choice /C:SN0
...
echo:             [2] KMS38       ^|  Windows           ^|   2038 Anos
echo:             [3] Online KMS  ^|  Windows / Office  ^|   180 Dias
echo:             __________________________________________________      
echo:                                                                     
echo:             [4] Checar Status da Ativacao [vbs]
echo:             [5] Checar Status da Ativacao [wmi]
echo:             __________________________________________________      
echo:                                                                     
echo:             [6] Extras                                               
echo:             [7] Leia me
...
echo:       ______________________________________________________________
echo:
call :_color2 %_White% "         " %_Green% "Entre com as opcoes [1,2,3,4,5,6,7,8] :"
choice /C:12345678 /N
set _erl=%errorlevel%

if %_erl%==8 goto Menu2
if %_erl%==7 echo: tirei 
if %_erl%==6 goto:Extras
if %_erl%==5 setlocal & call :_Check_Status_wmi & cls & endlocal & goto :Menu3
if %_erl%==4 setlocal & call :_Check_Status_vbs & cls & endlocal & goto :Menu3
if %_erl%==3 setlocal & call :KMSActivation     & cls & endlocal & goto :Menu3
if %_erl%==2 setlocal & call :KMS38Activation   & cls & endlocal & goto :Menu3
if %_erl%==1 setlocal & call :HWIDActivation    & cls & endlocal & goto :Menu3
goto :Menu3
...
echo:       ______________________________________________________________
echo:
echo:             [1] Solucao de problemas de ativacao
echo:
echo:             [2] Extrair pasta $OEM$
echo:
echo:             [3] Insira a chave HWID do Windows
echo:
echo:             [4] Alterar edicao do Windows
echo:             __________________________________________________      
echo:                                                                     
echo:             [5] Menu Anterior
echo:       ______________________________________________________________
echo:
call :_color2 %_White% "           " %_Green% "Entre com as opcoes [1,2,3,4,5] :"
choice /C:12345 /N
set _erl=%errorlevel%

if %_erl%==5 goto :Menu3
...
echo:
echo:
echo:                   Extraia a pasta $OEM$ na area de trabalho             
echo:       ______________________________________________________________
echo:                                                            
echo:             [1] HWID
echo:             [2] KMS38
...
echo:       ______________________________________________________________
echo:  
call :_color2 %_White% "           " %_Green% "Insira uma opcao de menu no teclado:"
choice /C:123456 /N
set _erl=%errorlevel%
